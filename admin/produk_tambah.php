      ...
      <div class="card" style="max-width:600px;">
        ...
        <form method="POST" action="produk_tambah.php">
          <div class="form-row">
            ...
            <input type="text" id="nama_produk" name="nama_produk" value="<?= htmlspecialchars($nama_produk) ?>"
              placeholder="Contoh: Paket Ayam Penyet" required>
          </div>
          ...
          <div class="form-row">
            ...
            <input type="number" id="harga" name="harga" value="<?= htmlspecialchars($harga) ?>" placeholder="20000"
              min="0" required>
          </div>
          ...
          <div class="form-row">
            ...
            <textarea id="deskripsi" name="deskripsi" rows="3"
              placeholder="Deskripsi singkat produk"><?= htmlspecialchars($deskripsi) ?></textarea>
          </div>
